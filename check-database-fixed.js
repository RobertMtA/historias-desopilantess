...
async function listTables() {
  try {
    ...
    console.log(`${colors.green}Tablas encontradas: ${colors.reset}`);
...
async function describeTable(tableName) {
  try {
    ...
    console.log(`${colors.cyan}Columnas encontradas: ${colors.reset}`);
    console.log('--------------------------------------------------');
...
async function showSampleData(tableName, limit = 3) {
  try {
    console.log(`\nMuestra de datos de la tabla "${tableName}":`);
